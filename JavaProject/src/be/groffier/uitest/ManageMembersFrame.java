...
public class ManageMembersFrame extends JFrame {
	...
	public ManageMembersFrame() {
		...
		String[] columnNames = {"ID", "Nom", "Prénom", "Téléphone", "Balance (€)"};
		...
		tableMembres.getColumnModel().getColumn(0).setPreferredWidth(50);
		tableMembres.getColumnModel().getColumn(1).setPreferredWidth(150);
		tableMembres.getColumnModel().getColumn(2).setPreferredWidth(150);
		tableMembres.getColumnModel().getColumn(3).setPreferredWidth(120);
		tableMembres.getColumnModel().getColumn(4).setPreferredWidth(100);
	...
	private void loadMembers() {
		...
		List<Member> members = personDAO.getAllMembers();
